        ...
        >
            <div className="container relative z-10 w-full px-4 sm:px-6">
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-7">
                    ...
                    {/* 1. Main Title (AXA -> Medical City) */}
                    <h1 className="tracking-tight leading-none text-center">
                        <span className="hero-anim-1 text-6xl sm:text-7xl lg:text-8xl font-black text-white block drop-shadow-[0_10px_25px_rgba(0,0,0,0.8)] tracking-wider">
                            AXA
                        </span>
                        <span className="hero-anim-2 text-3xl sm:text-5xl lg:text-6xl font-black block mt-3 bg-gradient-to-r from-white via-cyan-100 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_10px_20px_rgba(0,229,255,0.2)] uppercase tracking-tight">
                            Medical City
                        </span>
                    </h1>

                    {/* 2. Byline / Signature */}
                    <div className="hero-anim-3 flex items-center justify-center gap-2 sm:gap-2.5">
                        <span className="w-4 sm:w-6 h-[1px] bg-cyan-400/60 inline-block shadow-sm shadow-cyan-400/30"></span>
                    ...
                    <div className="hero-anim-5 flex flex-wrap gap-4 justify-center items-center pt-2">
                        ...
                        <Link 
                            to="/products" 
                            className="group flex items-center justify-center gap-2 bg-cyan-400 hover:bg-cyan-300 text-slate-950 px-7 py-3.5 text-sm sm:text-base rounded-2xl font-black tracking-wide shadow-xl shadow-cyan-400/30 hover:shadow-2xl hover:shadow-cyan-400/40 hover:-translate-y-1 hover:scale-105 active:translate-y-0 active:scale-100 transition-all duration-300 cursor-pointer"
                        >
                            <span>Products</span>
                        </Link>
                        {/* Secondary Button */}
